...
CREATE TABLE `transaction` (
  ...
  `amount` decimal(39,0) NOT NULL COMMENT 'This amount is always ICX',
  `step_limit` bigint(60) NOT NULL,
  `step_used` bigint(60) NOT NULL,
  `step_price` bigint(60) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `hash_UNIQUE` (`hash`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `block_id_idx` (`block`),
...
) ENGINE=InnoDB AUTO_INCREMENT=703389 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
